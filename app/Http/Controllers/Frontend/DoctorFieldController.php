...
class DoctorFieldController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.doctorFields.index', compact('doctorFields'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.doctorFields.create');
    }
    ...
    public function store(StoreDoctorFieldRequest $request)
    {
        ...
        return redirect()->route('frontend.doctor-fields.index');
    }
    ...
    public function edit(DoctorField $doctorField)
    {
        ...
        return view('frontend.doctorFields.edit', compact('doctorField'));
    }
    ...
    public function show(DoctorField $doctorField)
    {
        ...
        return view('frontend.doctorFields.show', compact('doctorField'));
    }
