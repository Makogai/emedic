...
class DoctorPatientController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.doctorPatients.index', compact('doctorPatients'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.doctorPatients.create', compact('doctors', 'patients'));
    }
    ...
    public function store(StoreDoctorPatientRequest $request)
    {
        ...
        return redirect()->route('frontend.doctor-patients.index');
    }
    ...
    public function edit(DoctorPatient $doctorPatient)
    {
        ...
        return view('frontend.doctorPatients.edit', compact('doctorPatient', 'doctors', 'patients'));
    }
    ...
    public function show(DoctorPatient $doctorPatient)
    {
        ...
        return view('frontend.doctorPatients.show', compact('doctorPatient'));
    }
