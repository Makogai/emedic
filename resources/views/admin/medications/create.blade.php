...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.medications.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('usage') ? 'is-invalid' : '' }}" name="usage" id="usage">{!! old('usage') !!}</textarea>
                @if($errors->has('usage'))
                    <div class="invalid-feedback">
                        {{ $errors->first('usage') }}
                    </div>
            ...
            <div class="form-group">
                <label for="image">{{ trans('cruds.medication.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.medication.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    url: '{{ route('admin.medications.storeMedia') }}',
    maxFilesize: 2, // MB
    ...
    init: function () {
@if(isset($medication) && $medication->image)
      var file = {!! json_encode($medication->image) !!}
