    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registration_code') ? 'is-invalid' : '' }}" type="text" name="registration_code" id="registration_code" value="{{ old('registration_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jmbg') ? 'is-invalid' : '' }}" type="text" name="jmbg" id="jmbg" value="{{ old('jmbg', '') }}" required>
                @if($errors->has('jmbg'))
