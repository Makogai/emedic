                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tests.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tip" id="tip" value="{{ old('tip', '') }}" required>
                            @if($errors->has('tip'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tip') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="blood_preasure" id="blood_preasure" value="{{ old('blood_preasure', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="heart_rate" id="heart_rate" value="{{ old('heart_rate', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="oxygen" id="oxygen" value="{{ old('oxygen', '') }}" step="1">
