                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="registration_code" id="registration_code" value="{{ old('registration_code', $user->registration_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="bio" id="bio">{!! old('bio', $user->bio) !!}</textarea>
                            @if($errors->has('bio'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bio') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="sector_id" id="sector_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jmbg" id="jmbg" value="{{ old('jmbg', $user->jmbg) }}" required>
                            @if($errors->has('jmbg'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jmbg') }}
                                </div>
