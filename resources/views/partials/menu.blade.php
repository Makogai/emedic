<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/users*") ? "c-show" : "" }} {{ request()->is("admin/doctor-patients*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('doctor_patient_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.doctor-patients.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/doctor-patients") || request()->is("admin/doctor-patients/*") ? "c-active" : "" }}">
        ...
        @can('medication_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.medications.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/medications") || request()->is("admin/medications/*") ? "c-active" : "" }}">
